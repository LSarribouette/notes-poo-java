...
Méthodologie : 
    ...
    - on décide quelle classe va implémenter l'autre (ici disons `MaClasseA`)  
...
There are two forms of association
    ...
    Composition : relation d'obligation car si A est composée de B, alors la suppression de A implique la suppression de B
    Aggregation : relation non-obligatoire car si C est agrégé par D et E, alors la suppression de C n'entraîne pas la suppression de D et E
